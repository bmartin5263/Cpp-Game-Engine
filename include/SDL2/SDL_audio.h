 ...
 *
 * Supported formats are RIFF WAVE file with the formats PCM (8, 16, 24, and
 ...
 * problematic file in the wild that cause issues with strict decoders. To
 * provide compatibility with these file, this decoder is lenient in regards
