 ...
 *
 * If both hints were set then SDL_RWFromFile() will look into expansion file
 * after a given relative path was not found in the internal storage and assets.
 *
 * By default this hint is not set and the APK expansion file are not searched.
 */
 ...
 *
 *  Note that file that have trailing data unrelated to the WAVE file or
 *  corrupt file may slow down the loading process without a reliable boundary.
