...
bool OpenGLGraphics::startupImpl(int width, int height) {
    glfwInit();
...
void OpenGLGraphics::shutdownImpl() {
    glfwTerminate();
}

void OpenGLGraphics::updateImpl() {
...
bool OpenGLGraphics::isRunningImpl() const {
    return !glfwWindowShouldClose(window);
}

void OpenGLGraphics::makeCube(MeshData<MyVertex> *m) {
...
//    m->vertices()[0] = MyVertex(-.5f, -.5f, -.5f,  0.0f, 0.0f);
//    m->vertices()[1] = MyVertex(0.5f, -.5f, -.5f,  1.0f, 0.0f);
//    m->vertices()[2] = MyVertex(0.5f, 0.5f, -.5f,  1.0f, 1.0f);
//    m->vertices()[3] = MyVertex(-.5f, -.5f, 0.5f,  0.0f, 0.0f);
//    m->vertices()[4] = MyVertex(0.5f, -.5f, 0.5f,  1.0f, 0.0f);
//    m->vertices()[5] = MyVertex(0.5f, 0.5f, 0.5f,  1.0f, 1.0f);
//    m->vertices()[6] = MyVertex(-.5f, 0.5f, 0.5f,  0.0f, 1.0f);
//
//    m->triangles()[0] = Triangle(0, 1, 2);
//    m->triangles()[1] = Triangle(2, 3, 0);
//    m->triangles()[2] = Triangle(4, 5, 6);
//    m->triangles()[3] = Triangle(6, 7, 4);
//    m->triangles()[4] = Triangle(7, 3, 0);
//    m->triangles()[5] = Triangle(0, 4, 7);
//    m->triangles()[6] = Triangle(6, 2, 1);
//    m->triangles()[7] = Triangle(1, 5, 6);
//    m->triangles()[8] = Triangle(0, 1, 5);
//    m->triangles()[9] = Triangle(5, 4, 0);
